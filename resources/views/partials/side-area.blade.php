...
<line fill="none" stroke="#000000" stroke-miterlimit="10" x1="22.785" y1="5.005" x2="4.719" y2="21.989"/>
    ...
    <div id="qodef-side-area-inner">
        <div id="media_image-2" class="widget widget_media_image" data-area="side-area"><a href="/">
                <img width="271"
                     height="117"
                     src="{{ asset('wp-content/uploads/2023/09/yaele_logo_gold.svg') }}"
                     class="image wp-image-4332  attachment-full size-full"
                     alt=""
                     decoding="async"
        ...
        <div id="text-8" class="widget widget_text" data-area="side-area">
            <div class="textwidget"><h6 style="color: #c28562;">
                    @lang('site.home-desc-5')
                </h6>
            </div>
        </div>
        <div id="text-9" class="widget widget_text" data-area="side-area">
            <div class="textwidget"><p><span style="color: #d7926b;">T</span>:
                    <a href="tel:0040723284326">
                        079 443 390
                    </a>
                    <br/>
